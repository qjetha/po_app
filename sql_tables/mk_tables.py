...
db.execute('''CREATE TABLE po_data (
	id NUMERIC,
	noticed_mural BOOLEAN,
	heard_GTT NUMERIC,
	GTT_importance NUMERIC,
	mural_uncomfortable NUMERIC,
	enjoy_mural NUMERIC,
	history_fairly NUMERIC,
	welcome_public NUMERIC,
	mural_offensive NUMERIC,
	mural_effective NUMERIC,
	mural_unwelcome NUMERIC,
	mural_accuracy NUMERIC,
	mural_represent_today NUMERIC,
	med_years NUMERIC,
	med_residence TEXT,
	race TEXT,
	age TEXT,
...
with open('/Users/qayamjetha/Desktop/po_app/data/po_data_clean.csv') as file:
